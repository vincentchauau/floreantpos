 ...
 * Disclaimer:
 * <br />
 * This software and all specifications and documentation contained herein or
 * provided to you hereunder (the "Software") are provided free of charge
 * strictly on an "AS IS" basis. No representations or warranties are expressed
 * or implied, including, but not limited to, warranties of suitability,
 * quality, merchantability, or fitness for a particular purpose (irrespective
 * of any course of dealing, custom or usage of trade), and all such warranties
 * are expressly and specifically disclaimed. Mercury Payment Systems shall have
 * no liability or responsibility to you nor any other person or entity with
 * respect to any liability, loss, or damage, including lost profits whether
 * foreseeable or not, or other obligation for any cause whatsoever, caused or
 * alleged to be caused directly or indirectly by the Software. Use of the
 * Software signifies agreement with this disclaimer notice.
 *
...
public class MercuryWebRequest {
     ...
     * @throws Exception When no parameters have been added to the
     * MercuryWebRequest
     */
    ...
    /**
     * Add WebMethod parameter, overwrites the value if parameter name already
     * exists
     *
     ...
     *
     * @throws Exception When missing required parameters or containing invalid
     * parameters
     */
