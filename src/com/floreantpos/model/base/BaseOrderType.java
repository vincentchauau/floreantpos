...
/**
 * This is an object that contains data related to the ORDER_TYPE table. Do not
 * modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class table="ORDER_TYPE"
 */
public abstract class BaseOrderType implements Comparable, Serializable {
     ...
     * HIDE_ITEM_WITH_EMPTY_INVENTORY
     */
     ...
     *
     * @param hideItemWithEmptyInventory the HIDE_ITEM_WITH_EMPTY_INVENTORY
     * value
     */
    ...
    /**
     * Return the value associated with the column:
     * SHOW_UNIT_PRICE_IN_TICKET_GRID
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof com.floreantpos.model.OrderType)) {
            return false;
        } else {
