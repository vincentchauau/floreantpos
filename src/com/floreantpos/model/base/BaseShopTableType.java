...
/**
 * This is an object that contains data related to the SHOP_TABLE_TYPE table. Do
 * not modify this class because it will be overwritten if the configuration
 * file related to this class is modified.
 *
 * @hibernate.class table="SHOP_TABLE_TYPE"
 */
public abstract class BaseShopTableType implements Comparable, Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof com.floreantpos.model.ShopTableType)) {
            return false;
        } else {
