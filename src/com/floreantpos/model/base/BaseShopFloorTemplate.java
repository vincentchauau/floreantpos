...
/**
 * This is an object that contains data related to the SHOP_FLOOR_TEMPLATE
 * table. Do not modify this class because it will be overwritten if the
 * configuration file related to this class is modified.
 *
 * @hibernate.class table="SHOP_FLOOR_TEMPLATE"
 */
public abstract class BaseShopFloorTemplate implements Comparable, Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof com.floreantpos.model.ShopFloorTemplate)) {
            return false;
        } else {
