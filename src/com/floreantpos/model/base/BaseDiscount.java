...
/**
 * This is an object that contains data related to the COUPON_AND_DISCOUNT
...
public abstract class BaseDiscount implements Comparable, Serializable {
    ...
    public void addTomenuItems(com.floreantpos.model.MenuItem menuItem) {
        if (null == getMenuItems()) {
            setMenuItems(new java.util.ArrayList<com.floreantpos.model.MenuItem>());
        }
    ...
    public void addTomenuGroups(com.floreantpos.model.MenuGroup menuGroup) {
        if (null == getMenuGroups()) {
            setMenuGroups(new java.util.ArrayList<com.floreantpos.model.MenuGroup>());
        }
    ...
    public void addTomenuCategories(com.floreantpos.model.MenuCategory menuCategory) {
        if (null == getMenuCategories()) {
            setMenuCategories(new java.util.ArrayList<com.floreantpos.model.MenuCategory>());
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof com.floreantpos.model.Discount)) {
            return false;
        } else {
