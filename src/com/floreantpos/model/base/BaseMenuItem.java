...
public abstract class BaseMenuItem implements Comparable, Serializable {
     ...
     * DISABLE_WHEN_STOCK_AMOUNT_IS_ZERO
     */
     ...
     *
     * @param disableWhenStockAmountIsZero the DISABLE_WHEN_STOCK_AMOUNT_IS_ZERO
     * value
     */
    ...
    public void addTopizzaPriceList(com.floreantpos.model.PizzaPrice pizzaPrice) {
        if (null == getPizzaPriceList()) {
            setPizzaPriceList(new java.util.ArrayList<com.floreantpos.model.PizzaPrice>());
        }
    ...
    public void addTodiscounts(com.floreantpos.model.Discount discount) {
        if (null == getDiscounts()) {
            setDiscounts(new java.util.ArrayList<com.floreantpos.model.Discount>());
        }
    ...
    public void addTomenuItemModiferGroups(com.floreantpos.model.MenuItemModifierGroup menuItemModifierGroup) {
        if (null == getMenuItemModiferGroups()) {
            setMenuItemModiferGroups(new java.util.ArrayList<com.floreantpos.model.MenuItemModifierGroup>());
        }
    ...
    public void addToterminals(com.floreantpos.model.Terminal terminal) {
        if (null == getTerminals()) {
            setTerminals(new java.util.ArrayList<com.floreantpos.model.Terminal>());
        }
    ...
    public void addToorderTypeList(com.floreantpos.model.OrderType orderType) {
        if (null == getOrderTypeList()) {
            setOrderTypeList(new java.util.ArrayList<com.floreantpos.model.OrderType>());
        }
