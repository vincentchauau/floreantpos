...
/**
 * This is an object that contains data related to the TAX_GROUP table. Do not
 * modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class table="TAX_GROUP"
 */
public abstract class BaseTaxGroup implements Comparable, Serializable {
     ...
     *
     * @hibernate.id generator-class="com.floreantpos.util.GlobalIdGenerator"
     * column="ID"
     */
    ...
    public void addTotaxes(com.floreantpos.model.Tax tax) {
        if (null == getTaxes()) {
            setTaxes(new java.util.ArrayList<com.floreantpos.model.Tax>());
        }
        getTaxes().add(tax);
    }
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof com.floreantpos.model.TaxGroup)) {
            return false;
        } else {
            com.floreantpos.model.TaxGroup taxGroup = (com.floreantpos.model.TaxGroup) obj;
            if (null == this.getId() || null == taxGroup.getId()) {
                return false;
            } else {
                return (this.getId().equals(taxGroup.getId()));
            }
        }
    }
    public int hashCode() {
