...
/**
 * This is an object that contains data related to the DELIVERY_CONFIGURATION
 * table. Do not modify this class because it will be overwritten if the
 * configuration file related to this class is modified.
 *
 * @hibernate.class table="DELIVERY_CONFIGURATION"
 */
public abstract class BaseDeliveryConfiguration implements Comparable, Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof com.floreantpos.model.DeliveryConfiguration)) {
            return false;
        } else {
