...
/**
 * This is an object that contains data related to the DELIVERY_INSTRUCTION
 * table. Do not modify this class because it will be overwritten if the
 * configuration file related to this class is modified.
 *
 * @hibernate.class table="DELIVERY_INSTRUCTION"
 */
public abstract class BaseDeliveryInstruction implements Comparable, Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof com.floreantpos.model.DeliveryInstruction)) {
            return false;
        } else {
