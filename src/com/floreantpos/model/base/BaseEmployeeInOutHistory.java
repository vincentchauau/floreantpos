...
/**
 * This is an object that contains data related to the EMPLOYEE_IN_OUT_HISTORY
 * table. Do not modify this class because it will be overwritten if the
 * configuration file related to this class is modified.
 *
 * @hibernate.class table="EMPLOYEE_IN_OUT_HISTORY"
 */
public abstract class BaseEmployeeInOutHistory implements Comparable, Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof com.floreantpos.model.EmployeeInOutHistory)) {
            return false;
        } else {
