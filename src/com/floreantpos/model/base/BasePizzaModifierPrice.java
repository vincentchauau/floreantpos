...
/**
 * This is an object that contains data related to the PIZZA_MODIFIER_PRICE
 * table. Do not modify this class because it will be overwritten if the
 * configuration file related to this class is modified.
 *
 * @hibernate.class table="PIZZA_MODIFIER_PRICE"
 */
public abstract class BasePizzaModifierPrice implements Comparable, Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof com.floreantpos.model.PizzaModifierPrice)) {
            return false;
        } else {
