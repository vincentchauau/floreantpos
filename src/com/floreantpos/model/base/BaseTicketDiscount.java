...
/**
 * This is an object that contains data related to the TICKET_DISCOUNT table. Do
 * not modify this class because it will be overwritten if the configuration
 * file related to this class is modified.
 *
 * @hibernate.class table="TICKET_DISCOUNT"
 */
public abstract class BaseTicketDiscount implements Comparable, Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof com.floreantpos.model.TicketDiscount)) {
            return false;
        } else {
