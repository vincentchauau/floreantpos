...
/**
 * This is an object that contains data related to the CASH_DRAWER table. Do not
 * modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class table="CASH_DRAWER"
 */
public abstract class BaseCashDrawer implements Comparable, Serializable {
    ...
    public void addTocurrencyBalanceList(com.floreantpos.model.CurrencyBalance currencyBalance) {
        if (null == getCurrencyBalanceList()) {
            setCurrencyBalanceList(new java.util.TreeSet<com.floreantpos.model.CurrencyBalance>());
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof com.floreantpos.model.CashDrawer)) {
            return false;
        } else {
