...
/**
 * This is an object that contains data related to the RECEPIE table. Do not
...
public abstract class BaseRecepie implements Comparable, Serializable {
    ...
    public void addTorecepieItems(com.floreantpos.model.RecepieItem recepieItem) {
        if (null == getRecepieItems()) {
            setRecepieItems(new java.util.ArrayList<com.floreantpos.model.RecepieItem>());
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof com.floreantpos.model.Recepie)) {
            return false;
        } else {
