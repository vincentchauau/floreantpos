...
/**
 * This is an object that contains data related to the GLOBAL_CONFIG table. Do
 * not modify this class because it will be overwritten if the configuration
 * file related to this class is modified.
 *
 * @hibernate.class table="GLOBAL_CONFIG"
 */
public abstract class BaseGlobalConfig implements Comparable, Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof com.floreantpos.model.GlobalConfig)) {
            return false;
        } else {
