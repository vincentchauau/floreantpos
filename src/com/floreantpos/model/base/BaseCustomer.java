...
/**
 * This is an object that contains data related to the CUSTOMER table. Do not
...
public abstract class BaseCustomer implements Comparable, Serializable {
    ...
    public void addTodeliveryAddresses(com.floreantpos.model.DeliveryAddress deliveryAddress) {
        if (null == getDeliveryAddresses()) {
            setDeliveryAddresses(new java.util.ArrayList<com.floreantpos.model.DeliveryAddress>());
        }
    ...
    public void addTodeliveryInstructions(com.floreantpos.model.DeliveryInstruction deliveryInstruction) {
        if (null == getDeliveryInstructions()) {
            setDeliveryInstructions(new java.util.ArrayList<com.floreantpos.model.DeliveryInstruction>());
        }
