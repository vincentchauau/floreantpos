...
/**
 * This is an object that contains data related to the DRAWER_ASSIGNED_HISTORY
 * table. Do not modify this class because it will be overwritten if the
 * configuration file related to this class is modified.
 *
 * @hibernate.class table="DRAWER_ASSIGNED_HISTORY"
 */
public abstract class BaseDrawerAssignedHistory implements Comparable, Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof com.floreantpos.model.DrawerAssignedHistory)) {
            return false;
        } else {
