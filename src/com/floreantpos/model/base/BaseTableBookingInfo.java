 ...
 *
 * @hibernate.class table="TABLE_BOOKING_INFO"
 */
public abstract class BaseTableBookingInfo implements Comparable, Serializable {
    ...
    public void addTotables(com.floreantpos.model.ShopTable shopTable) {
        if (null == getTables()) {
            setTables(new java.util.ArrayList<com.floreantpos.model.ShopTable>());
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof com.floreantpos.model.TableBookingInfo)) {
            return false;
        } else {
