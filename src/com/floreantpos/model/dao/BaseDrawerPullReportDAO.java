...
public abstract class BaseDrawerPullReportDAO extends com.floreantpos.model.dao._RootDAO {
     ...
     * @param s the Session
     */
    public java.util.List<com.floreantpos.model.DrawerPullReport> findAll(Session s, Order defaultOrder) {
     ...
     *
     * @param drawerPullReport a transient instance containing new or updated
     * state
     */
