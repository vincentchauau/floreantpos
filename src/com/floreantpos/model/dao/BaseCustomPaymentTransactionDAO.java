...
public abstract class BaseCustomPaymentTransactionDAO extends com.floreantpos.model.dao._RootDAO {
     ...
     *
     * @param customPaymentTransaction a transient instance of a persistent
     * class
     ...
     *
     * @param customPaymentTransaction a transient instance containing new or
     * updated state
     */
     ...
     *
     * @param customPaymentTransaction a transient instance containing updated
     * state
     */
