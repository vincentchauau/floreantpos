...
public class SalesBalanceReportView extends JPanel {
	private SimpleDateFormat fullDateFormatter = new SimpleDateFormat("dd/MM/yyyy, h:m a"); //$NON-NLS-1$
	private SimpleDateFormat shortDateFormatter = new SimpleDateFormat("dd/MM/yyyy, h:m a"); //$NON-NLS-1$
