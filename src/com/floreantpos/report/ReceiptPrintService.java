...
public class ReceiptPrintService {
	...
	private static final SimpleDateFormat reportDateFormat = new SimpleDateFormat("dd/MM/yyyy, h:mm a"); //$NON-NLS-1$
	...
	public static HashMap populateTicketProperties(Ticket ticket, TicketPrintProperties printProperties, PosTransaction transaction) {
		...
		map.put(SERVER_NAME, POSConstants.RECEIPT_REPORT_SERVER_LABEL + ticket.getOwner());
                // Vincent
                DateFormat df = new SimpleDateFormat("dd/MM/yyyy, h:m a");
         	map.put(REPORT_DATE, POSConstants.RECEIPT_REPORT_DATE_LABEL + df.format(new Date()).toString());
