...
public class ReportService {
	private static SimpleDateFormat fullDateFormatter = new SimpleDateFormat("dd/MM/yyyy, h:m a"); //$NON-NLS-1$
	private static SimpleDateFormat shortDateFormatter = new SimpleDateFormat("dd/MM/yyyy, h:m a"); //$NON-NLS-1$
