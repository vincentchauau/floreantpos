...
public class HourlyLaborReportView extends TransparentPanel {
    ...
    private void viewReport() {
        ...
        try {
            ...
            properties.put("reportTime", getDateString(new Date())); //$NON-NLS-1$
            properties.put("fromDay", getDateString(fromDate)); //$NON-NLS-1$
            properties.put("toDay", getDateString(toDate)); //$NON-NLS-1$
