...
public class TerminalConfig {
	...
	private static final String ADMIN_PASSWORD = "admin_pass";//$NON-NLS-1$
        ...
        private static final String DISABLE_PIN = "disable_pin";//$NON-NLS-1$
	...
	public static boolean isShowDbConfigureButton() {
        ...
        public static void setDisablePIN(boolean show) {
		config.setProperty(DISABLE_PIN, show);
	}

	public static boolean isDisablePIN() {
		return config.getBoolean(DISABLE_PIN, false);
	}
